...
- **Duración entrenamiento:** 752.58 minutos (30 épocas con early stopping 15: se corrieron 25 épocas)
- **Gpu Utilizada:** GPU t4	
- **Tamaño del modelo:** 83.6 MB
- **Configuración:** 

|epochs|imgsz|batch|optimizer|lr0|lrf|weight_decay|patience|
|------|-----|-----|---------|---|---|------------|--------|
|30 |(1280,720)|1|Adam|0.01|No se utilizó| No se Utilizó|15|

- **métricas  Generales:**

|mAP50(B)|Precision |Recall |F1-score|
|--------|----------|-------|---------|
| 0.0674  |0.4516  |0.0892| 0.1490  |

- **métricas de Clases Principales:**

|Clase|mAP50(B)|Precision |Recall |F1-score|
|-----|--------|----------|-------|---------|
|0-link	 | 0.167567|0.255096	|0.375569| 0.41686 |
|1-button| 0.268716 |0.407643	|0.444254| 0.450574 |
|2-input | 0.068312|1.0	|0.0	|0.0	|
